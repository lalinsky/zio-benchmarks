...
fn producer(io: std.Io, q: *std.Io.Queue(u64), start: u64, end: u64, remaining: *std.atomic.Value(u64)) void {
    var i: u64 = start;
    while (i < end) : (i += 1) {
...
fn consumer(io: std.Io, q: *std.Io.Queue(u64), work_iters: u64, result: *u64) void {
    var acc: u64 = 0;
    while (true) {
